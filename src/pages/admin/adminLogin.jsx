    ...
    <>
     <Toaster toastOptions={3000} />
      <section className=" min-h-screen flex items-center justify-center">
        ...
        {/* login container */}
        <div className="bg-white  flex shadow-lg rounded-lg max-w-4xl">
          {/* image */}
          ...
          {/* form */}
          <div className="sm:w-1/2 border-2 pt-16 px-5 t">
            <div className=" mb-5 text-5xl font-bold capitalize text-primary animate-pulse text-center"> 
              LOG IN
            </div>
