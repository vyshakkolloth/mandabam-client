...
const Cards = () => {
    ...
    return (
        <section className="flex flex-col items-center justify-center text-center py-5 px-4  sm:px-20">
            ...
            {/* <div className="flex flex-row   items-center justify-evenly sm:flex-nowrap flex-wrap gap-5 mt-4 "> */}
            <div className="flex flex-row   items-center justify-around  flex-wrap gap-5 mt-4 ">
                ...
                {data.map((values, index) => (
                    ...
                    <div  className='max-w-sm flex flex-col items-center justify-center  glass p-4 rounded-lg border-2
                        ...
                        <img src={values.image[0]} alt="wedding" className="w-[15rem] h-[15rem] sm:max-w-[15rem] sm:max-h-[15rem] rounded-lg shadow-lg object-cover" />
                        <div className='flex flex-col items-start justify-start text-left max-w-[15rem] sm:max-w-[15rem]  '>
